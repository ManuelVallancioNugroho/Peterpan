            ...
            <div class="row ">
                <div class="col-md-12 comp-grid">
                    ...
                    <div  class="card animated fadeIn page-content">
                        <?php
                        $sum_of_Jumlah_barang = 0;
                        $sum_of_Harga_total = 0;
                        $counter = 0;
                        if(!empty($data)){
                        $rec_id = (!empty($data['id']) ? urlencode($data['id']) : null);
                        $sum_of_Jumlah_barang = $sum_of_Jumlah_barang + $data['Jumlah_barang'];
                        $sum_of_Harga_total = $sum_of_Harga_total + $data['Harga_total'];
                        $counter++;
                        ?>
                        <div id="page-report-body" class="">
                            <table class="table table-hover table-borderless table-striped">
                                ...
                                <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                    ...
                                    <tr  class="td-Harga_total">
                                        <th class="title"> ID Kategori: </th>
                                        <td class="value"><?php echo $data['Harga_total']; ?></td>
                                    </tr>
                                    <tr  class="td-Sumber">
