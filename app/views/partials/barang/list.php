        ...
        <div class="container-fluid">
            <div class="row ">
                <div class="col ">
                    ...
                    <h5 class="record-title">UKDW - YOGYAKARTA</h5>
                    <h6 class="record-title">KODE LOKASI : 11.01.07.00.08.01.016.014</h6>
                </div>
                <div class="col-sm-2 ">
                    <?php if($can_add){ ?>
                    <a  class="btn btn btn-warning" my-1" href="<?php print_link("barang/add") ?>">
                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <?php } ?>
                                                <th class="td-sno">#</th>
                                                <th  class="td-kode_barang"> Warna</th>
                                                ...
                                                <th  class="td-Harga_total"> Harga Beli</th>
                                                <th  class="td-Sumber"> Sumber</th>
                                                <th  class="td-Ruang"> ID Kategori</th>
                                        ...
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>">
                                            ...
                                            <tr>
                                                ...
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-Harga_total"> <span><?php echo number_format($data['Harga_total'],0 , "," ,"."); ?></span></td>
                                                    <td class="td-Sumber">
                                                    ...
                                                    <td class="td-Ruang">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/barang_Ruang_option_list'); ?>' 
                                                    ...
                                                    <td class="td-Kondisi">
                                                        <span <?php if($can_edit){ ?> data-source='<?php print_link('api/json/barang_Kondisi_option_list'); ?>' 
                                                    ...
                                                    <td class="page-list-action td-btn">
                                                        <div class="dropdown" >
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <?php if($can_view){ ?>
                                                                <a class="dropdown-item" href="<?php print_link("barang/view/$rec_id"); ?>">
                                                                    <i class="fa fa-eye"></i> View 
                                                                </a>
                                                                <?php } ?>
                                                                <?php if($can_edit){ ?>
                                                                <a class="dropdown-item" href="<?php print_link("barang/edit/$rec_id"); ?>">
                                                                    <i class="fa fa-edit"></i> Edit
                                                                </a>
                                                                <?php } ?>
                                                                <?php if($can_delete){ ?>
                                                                <a  class="dropdown-item record-delete-btn" href="<?php print_link("barang/delete/$rec_id/?csrf_token=$csrf_token&redirect=$current_page"); ?>" data-prompt-msg="Are you sure you want to delete this record?" data-display-style="modal">
