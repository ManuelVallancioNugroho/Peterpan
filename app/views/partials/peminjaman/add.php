                            ...
                            <div>
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="tgl_pengembalian">Tgl Pengembalian <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-tgl_pengembalian" class="form-control datepicker  datepicker"  required="" value="<?php  echo $this->set_field_value('tgl_pengembalian',""); ?>" type="datetime" name="tgl_pengembalian" placeholder="Enter Tgl Pengembalian" data-enable-time="false" data-min-date="" data-max-date="" data-date-format="Y-m-d" data-alt-format="F j, Y" data-inline="false" data-no-calendar="false" data-mode="single" />
                                                        <div class="input-group-append">
                                                            <span class="input-group-text"><i class="fa fa-calendar"></i></span>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="kode_barang">Jumlah <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        <input id="ctrl-kode_barang"  value="<?php  echo $this->set_field_value('kode_barang',""); ?>" type="text" placeholder="Enter Jumlah"  required="" name="kode_barang"  class="form-control " />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <select required=""  id="ctrl-nama_barang" name="nama_barang"  placeholder="Select a value ..."    class="custom-select" >
                                                                ...
                                                                <?php 
                                                                $nama_barang_options = $comp_model -> peminjaman_nama_barang_option_list();
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label class="control-label" for="nama_peminjam">Nama Peminjam <span class="text-danger">*</span></label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div class="">
                                                            <input id="ctrl-nama_peminjam"  value="<?php  echo $this->set_field_value('nama_peminjam',""); ?>" type="text" placeholder="Enter Nama Peminjam"  required="" name="nama_peminjam"  class="form-control " />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
