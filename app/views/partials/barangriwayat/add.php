                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <div class="form-group ">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                            <label class="control-label" for="Harga_total">ID Kategori <span class="text-danger">*</span></label>
                                                        </div>
                                                        <div class="col-sm-8">
                                                            <div class="">
                                                                <input id="ctrl-Harga_total"  value="<?php  echo $this->set_field_value('Harga_total',""); ?>" type="number" placeholder="Enter ID Kategori" step="1"  required="" name="Harga_total"  class="form-control " />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group ">
                                                        <div class="row">
                                                            <div class="col-sm-4">
                                                                <label class="control-label" for="Sumber">Jenis Barang <span class="text-danger">*</span></label>
                                                            </div>
                                                            <div class="col-sm-8">
                                                                <div class="">
                                                                    <input id="ctrl-Sumber"  value="<?php  echo $this->set_field_value('Sumber',""); ?>" type="text" placeholder="Enter Jenis Barang"  required="" name="Sumber"  class="form-control " />
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
